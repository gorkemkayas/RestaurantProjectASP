...
{
    public class MenuItemInventoryAddChefModel : PageModel
    {
        ...
        public MenuItemInventoryAddChefModel(IConfiguration configuration)
        {
        ...
        public IActionResult OnPost(int MenuItemId, int InventoryId, int RequiredQuantity)
        {
            ...
            return RedirectToPage("/Chef/MenuItemInventoryChef"); // Redirect after adding
        }
