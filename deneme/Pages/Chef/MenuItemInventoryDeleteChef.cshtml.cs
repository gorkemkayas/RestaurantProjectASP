...
{
    public class MenuItemInventoryDeleteChefModel : PageModel
    {
        private string? _connectionString;

        public MenuItemInventoryDeleteChefModel(IConfiguration configuration)
        {
        ...
        public IActionResult OnPost()
        {
            try
            {
                ...
                return RedirectToPage("/Chef/MenuItemInventoryChef"); // Redirect to the main page after deletion
            }
            catch (Exception)
            {
