...
{
    public class MenuItemInventoryEditChefModel : PageModel
    {
        private string? _connectionString;

        public MenuItemInventoryEditChefModel(IConfiguration configuration)
        {
        ...
        public IActionResult OnPost()
        {
            try
            {
                ...
                return RedirectToPage("/Chef/MenuItemInventoryChef"); // Redirect back to MenuItems page
            }
            catch (Exception)
            {
