...
{
    public class MenuItemAddChefModel : PageModel
    {
        private readonly IConfiguration _configuration;
        public List<Menu> Menus { get; set; } = new List<Menu>();
        private readonly string connectionString;

        public MenuItemAddChefModel(IConfiguration configuration)
        {
        ...
        public IActionResult OnPost(int MenuId, string Name, double Price, string Description)
        {
            ...
            try
            {
                ...
                return RedirectToPage("/Chef/MenuItemChef"); // Redirect to the MenuItem page after adding
            }
            catch (Exception ex)
            {
