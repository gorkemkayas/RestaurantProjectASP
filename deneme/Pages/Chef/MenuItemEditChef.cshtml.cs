...
{
    public class MenuItemEditChefModel : PageModel
    {
        private string? _connectionString;

        public MenuItemEditChefModel(IConfiguration configuration)
        {
        ...
        public IActionResult OnPost()
        {
            try
            {
                ...
                return RedirectToPage("/Chef/MenuItemChef"); // Make sure this points to the correct page
            }
            catch (Exception)
            {
